...
export default async function AdminEnquiriesPage() {
  ...
  return (
    <div className="p-6 lg:p-8">
      <div className="mb-6">
        <h1 className="font-display font-bold text-2xl text-neutral-900">Enquiries</h1>
        <p className="text-neutral-500 text-sm mt-0.5">{enquiries.length} customer request{enquiries.length !== 1 ? 's' : ''} total</p>
      </div>
                    ...
                    <tr key={enq.id} className="hover:bg-neutral-50/50 transition-colors">
                      ...
                      <td className="p-4">
                        {car ? (
                          ...
                          <span className="text-neutral-400 font-light italic">General Enquiry</span>
                        )}
                      </td>
                      <td className="p-4 max-w-[250px] break-words text-neutral-600 leading-relaxed font-light">
                        {enq.message || <span className="text-neutral-300 italic">No message provided</span>}
                      </td>
