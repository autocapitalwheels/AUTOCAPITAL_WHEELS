    ...
    <div className="min-h-screen bg-[#faf9f6]/30 pt-20">
      ...
      <div className="bg-[#faf9f6] text-neutral-900 py-14 px-4 border-b border-neutral-200/60">
        <div className="container-custom max-w-4xl text-center">
          ...
          <h1 className="font-display font-black text-3xl sm:text-4xl text-neutral-900">Terms & Conditions</h1>
      ...
      <div className="container-custom max-w-4xl py-12 px-4">
        <div className="bg-white border border-neutral-200/80 rounded-2xl p-6 sm:p-10 space-y-6 text-neutral-600 font-light leading-relaxed text-sm sm:text-base">
          ...
          <section className="space-y-3">
            <h2 className="font-display font-bold text-lg sm:text-xl text-neutral-900">1. Acceptance of Terms</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="font-display font-bold text-lg sm:text-xl text-neutral-900">2. Vehicle Listings & Descriptions</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="font-display font-bold text-lg sm:text-xl text-neutral-900">3. Buying & Selling Transactions</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="font-display font-bold text-lg sm:text-xl text-neutral-900">4. User Accounts & Safety</h2>
            <p>
